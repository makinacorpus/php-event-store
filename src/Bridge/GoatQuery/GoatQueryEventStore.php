...
use MakinaCorpus\EventStore\Error\AggregateDoesNotExistError;
use MakinaCorpus\Message\Property;
use Ramsey\Uuid\UuidInterface;

final class GoatQueryEventStore extends AbstractEventStore
{
    ...
    {
        return new GoatQueryEventQuery($this);
    }
    ...
    {
        if (!$query instanceof GoatQueryEventQuery) {
            throw new \InvalidArgumentException(
                \sprintf(
                    "Query must be a %s instance, %s given",
                    GoatQueryEventQuery::class, \get_class($query)
                )
            );
        }
