...
namespace MakinaCorpus\EventStore\Tests\Projector\State;

use Goat\Runner\Runner;
use Goat\Runner\Testing\DatabaseAwareQueryTest;
use Goat\Runner\Testing\TestDriverFactory;
use MakinaCorpus\EventStore\Bridge\GoatQuery\Projector\State\GoatQueryStateStore;
use MakinaCorpus\EventStore\Projector\State\StateStore;

final class GoatQueryStateStoreTest extends DatabaseAwareQueryTest
{
    ...
    protected function createStateStore(Runner $runner, string $schema): StateStore
    {
        ...
        return new GoatQueryStateStore($runner, $schema);
    }
